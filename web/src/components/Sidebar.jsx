...
export default function Sidebar({ onCreate }) {
  ...
  return (
    <div style={{ width: 262, flex: "0 0 262px", borderRight: "1px solid var(--border)", background: "var(--panel)", display: "flex", flexDirection: "column", minHeight: 0 }}>
      ...
      <div style={{ margin: "10px 12px 6px", display: "flex", alignItems: "center", gap: 8 }}>
        <div style={{ fontSize: 10, fontFamily: "var(--mono)", letterSpacing: ".1em", color: "var(--dim2)", textTransform: "uppercase" }}>tmux 세션</div>
